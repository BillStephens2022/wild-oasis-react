...
const PAGE_SIZE = 10;  // number of results to show per page
  ...
  return(
    <StyledPagination>
      ...
      <Buttons>
        ...
        <PaginationButton onClick={nextPage} disabled={currentPage === pageCount}><span>Next</span><HiChevronRight /></PaginationButton>
      </Buttons>
    </StyledPagination>
  )
}
